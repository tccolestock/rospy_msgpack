...
"""
Privides a common base for other parts of the library to use to make
 serializable structures for msgpack. For use with the ZeroMQ socket
 communication.
...
# ------------------ Universal Basic Functions -----------------------------
    def xyz(cls, obj, uniq, desc):
        # receives the object, a unique identifier if needed, and the
        # descriptive term
        msg = {}
...
# ------------------ Controller_Manager Messages -----------------------------
    def controller_statistics(cls, obj, uniq):
        ...
        msg['time_last_control_loop_overrun'] = \
            obj.time_last_control_loop_overrun
        return(msg)
